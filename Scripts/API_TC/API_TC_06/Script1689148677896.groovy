...
WS.sendRequest(findTestObject('API/API_TC_06'))

WS.sendRequestAndVerify(findTestObject('API/API_TC_06'))

RequestObject requestObject = findTestObject('API/API_TC_06')
