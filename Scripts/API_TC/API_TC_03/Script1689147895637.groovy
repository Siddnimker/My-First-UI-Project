...
WS.sendRequest(findTestObject('API/API_TC_03'))

WS.sendRequestAndVerify(findTestObject('API/API_TC_03'))

RequestObject requestObject = findTestObject('API/API_TC_03')
