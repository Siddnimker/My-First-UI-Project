...
WS.sendRequest(findTestObject('API/API_TC_05'))

WS.sendRequestAndVerify(findTestObject('API/API_TC_05'))

RequestObject requestObject = findTestObject('API/API_TC_05')
