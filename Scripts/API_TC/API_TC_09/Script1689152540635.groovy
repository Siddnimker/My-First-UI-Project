...
WS.sendRequest(findTestObject('API/API_TC_09'))

WS.sendRequestAndVerify(findTestObject('API/API_TC_09'))

RequestObject requestObject = findTestObject('API/API_TC_09')
