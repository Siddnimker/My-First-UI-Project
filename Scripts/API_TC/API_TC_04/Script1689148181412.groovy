...
WS.sendRequest(findTestObject('API/API_TC_04'))

WS.sendRequestAndVerify(findTestObject('API/API_TC_04'))

RequestObject requestObject = findTestObject('API/API_TC_04')
...
Assert.assertEquals(404, responseObject.getStatusCode())
