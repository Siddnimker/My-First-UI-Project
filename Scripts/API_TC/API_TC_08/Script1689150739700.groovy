...
WS.sendRequest(findTestObject('API/API_TC_08'))

WS.sendRequestAndVerify(findTestObject('API/API_TC_08'))

RequestObject requestObject = findTestObject('API/API_TC_08')
