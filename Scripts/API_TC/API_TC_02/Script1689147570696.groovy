...
WS.sendRequest(findTestObject('API/API_TC_02'))


WS.sendRequestAndVerify(findTestObject('API/API_TC_02'))

RequestObject requestObject = findTestObject('API/API_TC_02')
