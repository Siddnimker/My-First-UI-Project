...
WS.sendRequest(findTestObject('API/API_TC_01'))

WS.sendRequestAndVerify(findTestObject('API/API_TC_01'))

RequestObject requestObject = findTestObject('API/API_TC_01')
