...
WS.sendRequest(findTestObject('API/API_TC_10'))

WS.sendRequestAndVerify(findTestObject('API/API_TC_10'))

RequestObject requestObject = findTestObject('API/API_TC_10')
